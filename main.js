...
form.addEventListener('submit',function(e){
    ...
    if(campoA >= campoB){
        const containerFalso = document.querySelector('.mensagen-error');
        containerFalso.innerHTML = mensagemFalso;
        containerFalso.style.display = 'block';
        document.querySelector('.mensagen-true').style.display = 'none';
    }
    else{     
        const containerVerdade = document.querySelector('.mensagen-true');
        containerVerdade.innerHTML = mensagemVerdade;
        containerVerdade.style.display = 'block';
        document.querySelector('.mensagen-error').style.display = 'none';
    }
});